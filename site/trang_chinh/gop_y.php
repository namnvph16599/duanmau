    ...
    <div class="container">
        ...
        <div class="row mt-4 mb-4">
            <div class="col-lg-6 col-md-6 col-sm-12 contact__self">
                ...
                <ul class="contact__self-list">
                    <li class="contact__self-item">
                        <a class="contact__self-link" href="#">sneakerstore.com</a>
                    </li>
                    <li class="contact__self-item">
                        <a class="contact__self-link" href="#">SĐT: 0376 021 530</a>
                    </li>
                    <li class="contact__self-item">
                        <a class="contact__self-link" href="#">Email: sneakerstore@gmail.com</a>
                    </li>
                    <li class="contact__self-item">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 contact__regist">
                ...
                <p>Cảm ơn quý khách đã góp ý chúng tôi xin chân thành cảm ơn !</p>
                ...
                <form>
                    ...
                    <textarea name="" id="" cols="200" rows="15" placeholder="Nội dung cần góp ý ...."></textarea>
                    <button type="submit">Gửi góp ý</button>
                </form>
            </div>
        </div>
    </div>
